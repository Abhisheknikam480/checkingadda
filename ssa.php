...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>Sukanya Samriddhi Account</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Girl Child's Age</label>
				<select  name="girl_age" class="form-control" id="formGroupExampleInput2" required>
			...
			<div class="mb-3">
				...
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="7.6% currently">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Deposit Period:</label>
				<input type="text" name="dperiod" class="form-control" id="formGroupExampleInput2" placeholder="15 Years" disabled>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Maturity Period:</label>
				<input type="text" name="mperiod" class="form-control" id="formGroupExampleInput2" placeholder="21 Years" disabled>
			</div>
			<div class="submit">
