...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>PM Vaya Vandhana Scheme</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Your Age:</label>
				<input type="text" name="age" class="form-control" id="formGroupExampleInput2" placeholder="60 Years and above">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">You Want To Receive Pension:</label>
			...
			<div class="mb-3">
				...
				<input type="text" name="period" class="form-control" id="formGroupExampleInput2" placeholder="10 Years" disabled>
			</div>
