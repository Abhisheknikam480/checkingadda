...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>SGBS(Sovereign Gold Bond Scheme)</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">One Gram Gold Price:</label>
				<input type="text" name="one_gram_price" class="form-control" id="formGroupExampleInput2" placeholder="Rs.4,662">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">How Many Grams You Invest:</label>
				<input type="text" name="total_gram" class="form-control" id="formGroupExampleInput2">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Annual Interest Rate:</label>
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="2.5/Year">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Interest Received:</label>
	...
	<?php
		...
		{
			$one_gram_price=$_GET['one_gram_price'];	
			$total_gram=$_GET['total_gram'];
			$anr=$_GET['anr'];
			$periodunit=$_GET['periodunit'];
			
			if($periodunit=='Semi Yearly')
			{
				$deposit_amount=$one_gram_price*$total_gram;
				$second_value=($deposit_amount*$anr*8)/100;
				$answer=$deposit_amount+$second_value;
				$half_yearly_interest=$second_value/(2*8);
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$deposit_amount</h2> <br><br>
					<h3>TOTAL INTEREST</h3> <h2 style='color:#3f3697;'>$second_value</h2> <br><br>
					<h3>SEMI YEARLY INTEREST</h3> <h2 style='color:#3f3697;'>$half_yearly_interest</h2>";
			}
			else
			{
				$second_value=($deposit_amount*$anr*8)/100;
				$answer=$deposit_amount+$second_value;
				$half_yearly_interest=$second_value/8;
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$answer</h2> <br><br>
					<h3>TOTAL INTEREST</h3> <h2 style='color:#3f3697;'>$second_value</h2> <br><br>
					<h3>YEARLY INTEREST</h3> <h2 style='color:#3f3697;'>$half_yearly_interest</h2>";
			}
		}
	?>
	</section>
