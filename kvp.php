...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>Kisan Vikas Patra</h1></center>
		</div>
		<div class="head">
			...
			<div class="mb-3">
				...
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="6.9%" disabled>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Period:</label>
				<input type="text" name="period" class="form-control" id="formGroupExampleInput2" placeholder="10 Years and 4 Months" disabled>
			</div>
