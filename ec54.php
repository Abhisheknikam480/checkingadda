...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>54EC BONDS</h1></center>
		</div>
		<div class="head">
			...
			<div class="mb-3">
				...
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="5.00% Currently">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Period:</label>
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="5 Years" disabled>
			</div>
			<div class="mb-3">
	...
	<?php
		if(isset($_GET['submit']))
		{
			...
			{
				$second_value=($deposit_amount*$anr*5)/100;
				$answer=$deposit_amount+$second_value;
				$half_yearly_interest=$second_value/(2*5);
			...
			else
			{
				$second_value=($deposit_amount*$anr*5)/100;
				$answer=$deposit_amount+$second_value;
				$half_yearly_interest=$second_value/5;
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$answer</h2> <br><br>
					<h3>TOTAL INTEREST</h3> <h2 style='color:#3f3697;'>$second_value</h2> <br><br>
