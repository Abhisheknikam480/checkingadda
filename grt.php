...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>Gratuity Scheme</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Employement Type:</label>
				<select  name="e_type" class="form-control" id="formGroupExampleInput2" required>
					<option>Government Employee</option>
					<option>Private Employee-Covered Under Gratuity Act</option>
					<option>Private Employee-Not Covered Under Gratuity Act</option>
				</select>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Last Drawn Monthly Basic Pay:</label>
				<input type="text" name="l_pay" class="form-control" id="formGroupExampleInput2" placeholder="Rs.">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Last Drawn Monthly DA(Dearness Allowance):</label>
				<input type="text" name="l_da" class="form-control" id="formGroupExampleInput2" placeholder="Rs.">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Employement Duration:</label>
				<input type="text" name="duration" class="form-control" id="formGroupExampleInput2" placeholder="Years">
			</div>
			<div class="mb-3">
