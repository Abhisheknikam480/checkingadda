...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>Post Office Recurring Deposit</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Monthly Deposit:</label>
				<input type="text" name="monthly_deposit" class="form-control" id="formGroupExampleInput2" placeholder="Rs.">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Annual Interest Rate:</label>
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="5.8% currently">
			</div>
			<div class="mb-3">
