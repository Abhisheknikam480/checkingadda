...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>FIXED DEPOSIT-TDR</h1></center>
		</div>
		<div class="head">
			...
			<div class="mb-3">
				...
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="%">
			</div>
			<div class="mb-3">
	...
	<?php
		if(isset($_GET['submit']))
		{
			...
			{
				$second_value=($deposit_amount*$anr*$period)/100;
				$real_second_value=$second_value/(12*$period);
				$answer=$deposit_amount+$second_value;
				$total_interest=$second_value;
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$answer</h2> <br><br>
					...
					<h3>MONTHLY INTEREST</h3> <h2 style='color:#3f3697;'>$real_second_value</h2>";
			}
			else if($periodunit=='Quarterly')
			{
				$second_value=($deposit_amount*$anr*$period)/100;
				$real_second_value=$second_value/(4*$period);
				$answer=$deposit_amount+$second_value;
				$total_interest=$second_value;
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$answer</h2> <br><br>
					<h3>TOTAL INTEREST</h3> <h2 style='color:#3f3697;'>$second_value</h2> <br><br>
					<h3>QUARTERLY INTEREST</h3> <h2 style='color:#3f3697;'>$real_second_value</h2>";
			}
			else if($periodunit=='Semi Yearly')
			{
				$second_value=($deposit_amount*$anr*$period)/100;
				$real_second_value=$second_value/(2*$period);
				$answer=$deposit_amount+$second_value;
				$total_interest=$second_value;
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$answer</h2> <br><br>
					<h3>TOTAL INTEREST</h3> <h2 style='color:#3f3697;'>$second_value</h2> <br><br>
					<h3>SEMI YEARLY INTEREST</h3> <h2 style='color:#3f3697;'>$real_second_value</h2>";
			}
			else
			{
				$second_value=($deposit_amount*$anr*$period)/100;
				$real_second_value=$second_value/$period;
				$answer=$deposit_amount+$second_value;
				$total_interest=$second_value;
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$answer</h2> <br><br>
					<h3>TOTAL INTEREST</h3> <h2 style='color:#3f3697;'>$second_value</h2> <br><br>
					<h3>YEARLY INTEREST</h3> <h2 style='color:#3f3697;'>$real_second_value</h2>";
			}
		}
	?>
	</section>
