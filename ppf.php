...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>Public Provident Fund</h1></center>
		</div>
		<div class="head">
			...
			<div class="mb-3">
				...
				<input type="text" name="anr" class="form-control" id="formGroupExampleInput2" placeholder="7.1% currently">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Maturity Period:</label>
				<input type="text" name="maturity_period" class="form-control" id="formGroupExampleInput2" placeholder="15 Full Financial Year" disabled>
			</div>
