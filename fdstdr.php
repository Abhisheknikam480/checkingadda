...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>Special Term Deposit Receipt</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Loan Amount:</label>
				<input type="text" name="loan_amount" class="form-control" id="formGroupExampleInput2" placeholder="Rs.">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Term:</label>
				<input type="text" name="loan_term" class="form-control" id="formGroupExampleInput2">
			</div>
			<div class="mb-3">
