...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>PM Shram Yogi Maan-dhan</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Your Age:</label>
				<input type="text" name="age" class="form-control" id="formGroupExampleInput2" placeholder="18 to 40 Years">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">You want to receive monthly pension</label>
				<input type="text" name="receive" class="form-control" id="formGroupExampleInput2" placeholder="Rs. 3,000" disabled>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">You Will pay your contributions:</label>
				<input type="text" name="contribution" class="form-control" id="formGroupExampleInput2" placeholder="Every Month" disabled>
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Retirement Age:</label>
				<input type="text" name="age" class="form-control" id="formGroupExampleInput2" placeholder="60 Years" disabled>
			</div>
