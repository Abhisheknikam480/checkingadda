...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>FRSB(FLOATING RATE SAVING BOND)</h1></center>
		</div>
		<div class="head">
			<form method="get" action="#">
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Lump Sum Deposit Amount:</label>
	...
	<?php
		if(isset($_GET['submit']))
		{
			...
			{
				$second_value=($deposit_amount*$anr*7)/100;
				$answer=$deposit_amount+$second_value;
				$half_yearly_interest=$second_value/(2*7);
			...
			else
			{
				$second_value=($deposit_amount*$anr*7)/100;
				$answer=$deposit_amount+$second_value;
				$half_yearly_interest=$second_value/7;
				echo"<h3>TOTAL AMOUNT</h3> <h2 style='color:#3f3697;'>$answer</h2> <br><br>
					<h3>TOTAL INTEREST</h3> <h2 style='color:#3f3697;'>$second_value</h2> <br><br>
