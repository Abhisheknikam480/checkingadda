...
<body>
  ...
  <div class="container-fluid title">
	...
	<section id="main">
		<div class="title">
			<center><h1>Atal Pension Scheme</h1></center>
		</div>
		<div class="head">
			...
			<div class="mb-3">
				...
				<select  name="receive" class="form-control" id="formGroupExampleInput2" required>
			...
			<div class="mb-3">
				...
				<select  name="contribution" class="form-control" id="formGroupExampleInput2" required>
